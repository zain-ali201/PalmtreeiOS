//
//  ExpireAdsViewController.swift
//  PalmTree
//
//  Created by SprintSols on 11/18/20.
...
class ExpireAdsViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate, NVActivityIndicatorViewable ,UISearchBarDelegate,NearBySearchDelegate,UIGestureRecognizerDelegate {
...
//                    SwiftyAd.shared.showInterstitial(from: self)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: ExpireAdsCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "ExpireAdsCollectionViewCell", for: indexPath) as! ExpireAdsCollectionViewCell
