...
struct ProfileUpdateData {
    ...
    var rateBar : ProfileUpdateRateBar!
    var simpleAds : String!
    var socialIcons : [ProfileUpdateSocialIcon]!
    var userEmail : String!
    var verifyButon : ProfileUpdateVerifyButton!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let rateBarData = dictionary["rate_bar"] as? [String:Any]{
            rateBar = ProfileUpdateRateBar(fromDictionary: rateBarData)
        }
        simpleAds = dictionary["simple_ads"] as? String
        socialIcons = [ProfileUpdateSocialIcon]()
        if let socialIconsArray = dictionary["social_icons"] as? [[String:Any]]{
            for dic in socialIconsArray{
                let value = ProfileUpdateSocialIcon(fromDictionary: dic)
        ...
        if let verifyButonData = dictionary["verify_buton"] as? [String:Any]{
            verifyButon = ProfileUpdateVerifyButton(fromDictionary: verifyButonData)
        }
    }
