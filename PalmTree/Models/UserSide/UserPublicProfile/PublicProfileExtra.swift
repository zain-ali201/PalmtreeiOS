...
struct PublicProfileExtra{
    ...
    var rateBar : PublicProfileRateBar!
    var simpleAds : String!
    var socialIcons : [PublicProfileIntro]!
    var userTypeButon : PublicProfileUserTypeButton!
    var userEmail : String!
    var verifyButon : PublicProfileUserTypeButton!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let rateBarData = dictionary["rate_bar"] as? [String:Any]{
            rateBar = PublicProfileRateBar(fromDictionary: rateBarData)
        }
        ...
        if let userTypeButonData = dictionary["userType_buton"] as? [String:Any]{
            userTypeButon = PublicProfileUserTypeButton(fromDictionary: userTypeButonData)
        }
        userEmail = dictionary["user_email"] as? String
        if let verifyButonData = dictionary["verify_buton"] as? [String:Any]{
            verifyButon = PublicProfileUserTypeButton(fromDictionary: verifyButonData)
        }
    }
